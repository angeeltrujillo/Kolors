...
export default function destinationSelector() {
    ...
    const destinationSuggestions = () => {
        return fetch('https://run.mocky.io/v3/47c7bbff-197b-4a30-b19e-8232653da18b')
  ...
  return (
    <View>
        <Modal visible={modalVisible} animationType="slide">
            <View style={{flex:1}}>
                <View style={styles.modalHeader}>
                    <LogoSvg />
                    <Text style={styles.modalText}>Destino</Text>
        ...
        <Pressable style={styles.container} onPress = { () => {
            ...
            <FontAwesome5 style={styles.icon} name="map-marker-alt" size={24} color="#8171B9" />
            <Text style={styles.fromText}>{selectedId ? selectedId : 'Destino'}</Text>
        </Pressable>
    </View>
